...
class InputBindingTests: XCTestCase {
    ...
    func testValidDoubleBinding() {
        var angle = CKDescriptors.Input.Location.Angle.instance()
    ...
    func testValidNSDataBinding() {
        var image = CKDescriptors.Input.Media.Image.instance()
    ...
    func testValidStructBinding() {
        var bb = CKDescriptors.Input.Location.BoundingBox.instance()
    ...
    func testTypeMismatchBinding() {
        var integer = CKDescriptors.Input.Numeric.Integer.instance()
