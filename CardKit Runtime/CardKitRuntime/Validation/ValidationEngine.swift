...
public class ValidationEngine {
    ...
    public func validate(deck: Deck) -> [ValidationError] {
        ...
        return self.executeValidation(validationActions)
    }
    
    /// Validates the given Hand in the given Deck.
    public func validate(hand: Hand, _ deck: Deck) -> [ValidationError] {
        var validationActions: [ValidationAction] = []
    ...
    public func validate(card: Card, _ hand: Hand, _ deck: Deck) -> [ValidationError] {
        var validationActions: [ValidationAction] = []
    ...
    func executeValidation(validationActions: [ValidationAction]) -> [ValidationError] {
